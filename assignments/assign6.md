...
- Objectives:
    The objective of this assignment is to implement the forward algorithm to build HMM for word recognition. We need to gain skills on how to implement a dynamic programming algorithm. 
...
- Task:
  ...
  - Implement **your own** version of the Forward algorithm algorithm (do not use the hmmlearn library for this function)
